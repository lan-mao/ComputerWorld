...
<assignment> --> <id> = <exmaple.E> ";"
<exmaple.E> --> <term> | <term> + <exmaple.E> | <term> - <exmaple.E>
<term> --> <primary> | <primary> * <term> | <primary> / <term>
<primary> --> <id> | <int> | <float> | <floatE> | "(" <exmaple.E> ")"

The definitions of the tokens are given in the lexical analyzer class file "exmaple.LexArithArray.java".

The following variables/functions of "exmaple.IO"/"exmaple.LexArithArray" classes are used:
...
static void setLex()
static String t // holds an extracted token  持有提取的令牌
...
public class Parser extends LexArithArray
{
