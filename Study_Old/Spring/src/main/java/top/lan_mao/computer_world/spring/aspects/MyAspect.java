...
public class MyAspect {
    ...
    public void before(){
        System.out.println("Aspectj前置通知执行");
    }

    @Before("execution(* *..service.*.doSomething(..))")
    public void before(JoinPoint joinPoint){
        System.out.println("Aspectj前置通知执行 jp=" + joinPoint);
    }
